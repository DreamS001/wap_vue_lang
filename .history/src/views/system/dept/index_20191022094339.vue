  ...
  <div class="p-box">
    ...
    <div class="search-box">
      ...
      <div class="search-item">
        ...
        <el-input v-model="query.value" clearable :placeholder="$t('proxy_code_search')" class="filter-item search-input" @keyup.enter.native="toQuery"/>
        <div style="display: inline-block;">
          <el-button
            class="filter-item filter-btn"
            size="mini"
            @click="changeExpand">{{ $parent.expand ? "{{$t('systemes.fold')}}" : "{{$t('systemes.fold')}}" }}</el-button>
        </div>
      </div>
      <div class="search-item">
        <span>
