    ...
    <div class="data-box">
      <div style="width:100%!important;margin-top:20px">
        <el-table :data="list" :header-row-class-name="handlemyclass"  style="width: 100%!important" :row-class-name="setClassName" :cell-style="finalCellStyle">
          ...
          <el-table-column style="color:red" prop="sta_profit" label="静态钱包收益（$）" min-width="160" align="center"/>
          <el-table-column style="color:red" prop="charge_price" label="充值金额（$）" min-width="150" align="center"/>
          <el-table-column style="color:red" prop="device_expend" label="购买机器人支出（$）" min-width="170" align="center"/>
